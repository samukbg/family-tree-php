...
<body class="min-h-screen" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);">
    ...
    <div class="fixed top-4 right-4 z-50 flex space-x-2">
        <button class="flag-btn active bg-white/20 backdrop-blur-sm px-3 py-2 rounded-lg hover:bg-white/30 transition-all duration-300" onclick="switchLanguage('pt')" id="pt-flag" title="Português">🇧🇷</button>
    ...
    <script>
        ...
        function openTree(treeId) {
            window.location.href = `index.php?tree=${treeId}`;
        }
